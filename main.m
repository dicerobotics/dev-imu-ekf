...
dispEstStates(xTrueComp, xMeasComp, xEstAVG, xPosIdx, time); suptitle('Measured/Estimated Position, ');
dispEstStates(xTrueComp, xMeasComp, xEstAVG, xVelIdx, time); suptitle('Measured/Estimated Velocity, ');
dispEstStates(xTrueComp, xMeasComp, xEstAVG, xABIdx, time); suptitle('Measured/Estimated aBias, ');
dispEstStates(xTrueComp, xMeasComp, xEstAVG, xWBIdx, time); suptitle('Measured/Estimated wBias, ');
dispEstStates(xTrueComp, xMeasComp, xEstAVG, xQuatIdx, time); suptitle('Measured/Estimated Quaternion, ');
dispEstStates(xTrueComp, xMeasComp, xEstAVG, xEulerIdx, time); suptitle('Measured/Estimated Euler, ');
